...
def generate_simplified_structure():
    ...
    erste_ebene_keys = random.sample(list(json_data['ersteEbene'].keys()), k=9)  # 7 einzigartige First-Level-Keys
...
template = env.get_template('gen13-to-html.html')
...
output_html_path = os.path.join(output_dir, 'gen13-to-html.html')
