...
template = env.get_template('1954-03_1_Seite_2(zufällige_Inhalte)-to-html.html')
...
output_html_path = os.path.join(output_dir, '1954-03_2_Seite_2(zufällige_Inhalte).html')
