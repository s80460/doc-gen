...
def generate_first_level():
    erste_ebene_keys = random.sample(list(json_data['ersteEbene'].keys()), k=random.randint(4, 9))
...
template = env.get_template('gen24-to-html.html')
...
output_html_path = os.path.join(output_dir, 'doc24.html')
