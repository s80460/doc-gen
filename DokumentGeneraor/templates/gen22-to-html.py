...
def generate_second_level():
    zweite_ebene_keys = random.sample(list(json_data['zweiteEbene'].keys()), k=random.randint(1, 5))
...
template = env.get_template('gen22-to-html.html')
...
output_html_path = os.path.join(output_dir, 'doc22.html')
