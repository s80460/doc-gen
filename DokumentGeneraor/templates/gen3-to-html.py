...
def generate_third_fourth_level():
    ...
    third_level_count = random.randint(2, 3)  # Jetzt können bis zu 4 Ebenen generiert werden
    third_level = {}
...
def generate_first_level():
    erste_ebene_keys = random.sample(list(json_data['ersteEbene'].keys()), k=random.randint(7, 11))
...
template = env.get_template('gen3-to-html.html')
...
output_html_path = os.path.join(output_dir, 'doc3.html')
