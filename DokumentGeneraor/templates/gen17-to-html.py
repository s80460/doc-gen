...
def generate_second_level():
    ...
    zweite_ebene_keys = random.sample(list(json_data['zweiteEbene'].keys()), k=random.randint(1, 4))

    zweite_ebene = {}
    for key in zweite_ebene_keys:
        # Den nächsten verfügbaren Buchstaben finden
...
template = env.get_template('gen17-to-html.html')
...
output_html_path = os.path.join(output_dir, 'doc17.html')
